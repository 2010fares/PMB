...
/**
 * Nombre de mots pertinents du texte à conserver
*/	
if (!isset($max_relevant_words)) $max_relevant_words=20;
/**
 * Nombre de termes à conserver aprés tri
*/
...
class autoindex_document {
	...
	/**
	 * tableau des mots distincts du document avec fréquence 
...
//TODO
//  		echo "Mots du document avec leur fréquence (".count($tab_words).") =\r\n";
//  		print_r($tab_words);
//  		echo "\r\n\n\n";
