...
// +-------------------------------------------------+
// $Id: autoindex_word.class.php,v 1.1.2.5 2013-10-29 10:50:03 dbellamy Exp $
...
class autoindex_stem {
	...
	public function __construct($label='', $frequency=0, $lang='fr_FR') {
...
class autoindex_word extends autoindex_stem {
	...
	public function __construct($label='', $frequency=0, $lang='fr_FR', $wo_lang=true) {
