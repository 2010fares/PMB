...
// +-------------------------------------------------+
// $Id: catal_form.tpl.php,v 1.117.2.1 2013-10-30 14:26:11 ngantier Exp $
...
$ptab[60] = "
	...
	<input type='button' class='bouton' value='$msg[parcourir]' onclick=\"openPopUp('./select.php?what=categorie&caller=notice&autoindex_class=autoindex_record&p1=f_categ_id!!icateg!!&p2=f_categ!!icateg!!&dyn=1&parent=0&deb_rech=', 'select_categ', 700, 500, -2, -2, '$select_categ_prop')\" />
