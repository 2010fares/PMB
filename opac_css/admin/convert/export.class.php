...
// +-------------------------------------------------+
// $Id: export.class.php,v 1.26.2.3 2013-10-29 11:21:18 mbertin Exp $
	...
	function get_next_notice($lender = "", $td = array(), $sd = array(), $keep_expl = false, $params=array(), $force_diffusion=false) {
		...
		if ($this -> current_notice != -1) {
			...
			if($res->niveau_biblio == 's' && $res->niveau_hierar == '1'){
				$req="SELECT collections_state.*, archempla_libelle, archtype_libelle, archstatut_opac_libelle, location_libelle FROM collections_state " .
