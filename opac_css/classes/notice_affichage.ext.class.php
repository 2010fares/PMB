...
// +-------------------------------------------------+
// $Id: notice_affichage.ext.class.php,v 1.182.2.26 2013-11-05 15:29:54 mbertin Exp $
...
class notice_affichage_ctles extends notice_affichage {
	...
	// Années de publication
		if ($this->notice->year)
			$this->notice_public .= "<tr><td align='left' class='bg-grey'><span class='etiq_champ'>".$msg['year_start']."</span></td><td>".$this->notice->year."</td></tr>" ;
	...
	// Catégories
		if ($this->categories_toutes) $this->notice_public .= "<tr><td align='left' class='bg-grey'><span class='etiq_champ'>".$msg['categories_start']."</span></td><td>".$this->categories_toutes."</td></tr>";
