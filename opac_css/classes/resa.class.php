...
// +-------------------------------------------------+
// $Id: resa.class.php,v 1.14.2.1 2013-10-25 13:51:21 dgoron Exp $
...
function check_statut() {
	...
	$query = "select expl_id from exemplaires e, docs_statut s, docs_location l, docs_section se";
	...
	$query .= " and s.statut_allow_resa=1 and s.statut_visible_opac=1 and l.location_visible_opac=1 and se.section_visible_opac=1";
	$query .= " and s.idstatut=e.expl_statut";
