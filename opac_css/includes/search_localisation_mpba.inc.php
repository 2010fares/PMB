...
// +-------------------------------------------------+
// $Id: search_localisation_mpba.inc.php,v 1.3.2.1 2013-10-15 12:12:19 mbertin Exp $
...
function search_other_function_filters() {
	...
	$r.="<option value=''>".htmlentities($msg["search_loc_mpba_site"],ENT_QUOTES,$charset)."</option>";
